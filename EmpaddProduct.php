...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$has_error)
    {
        ...
        header('Location: http://localhost/inventory_markscent/EmpaddProduct.php?addProduct_status='.$status);
        exit();
    }
   }
?>
    ...
    <div class="col-md-10">
            ...
            <div class="form-group">
                    ...
                    <select name="category" class="form-control <?php if(isset($category_error_msg)) echo 'is-invalid'; ?>">
                        <?php
                        // Assuming you have a function named getAllCategories to fetch all categories
