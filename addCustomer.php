...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$has_error)
    {
        ...
        // Add customer record
        $addCustomer = addCustomer($customername, $contactnumber, $email, $address);

        $status = '';
        if ($addCustomer === FALSE) {
            $status = 'error';
			
        } elseif ($addCustomer === 'existing'){
            $status = 'existing';
        }
        else{
            saveLog($_SESSION['user']['UserID'], 'Added ' . $customername . ' as customer.');
            $status = 'success';     
        }
        header('Location: http://localhost/inventory_markscent/addCustomer.php?addCustomer_status='.$status);
        exit();
    }
   }
?>
...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-10">
            <div>
              <a class="btn btn-primary btn-md" href="customerList.php">
            ...
            <br>
            <?php
		        if(isset($_GET['addCustomer_status']) && $_GET['addCustomer_status'] == 'success')
		    {
			    echo '<div class="alert-green" >The Customer has been successfully added.</div>';
		    }
		    elseif(isset($_GET['addCustomer_status']) && $_GET['addCustomer_status'] == 'error')
			{
			    echo '<div class="alert-red" >Error: Unable to add the Customer.</div>';
		    }
            elseif(isset($_GET['addCustomer_status']) && $_GET['addCustomer_status'] == 'existing')
			{
			    echo '<div class="alert-red" >Error: Customer already Exist.</div>';
		    }
	        ?> 
             ...
             <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="customername" class="form-control <?php if(isset($customername_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Customer Name" value="<?php if(isset($customername)) echo $customername;?>">
            ...
            <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="contactnumber" class="form-control <?php if(isset($contactnumber_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Contact Number"value="<?php if(isset($contactnumber)) echo $contactnumber;?>">
            ...
            <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="email" class="form-control <?php if(isset($email_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Email" value="<?php if(isset($email)) echo $email;?>">
            ...
            <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="address" class="form-control <?php if(isset($address_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Address" value="<?php if(isset($address)) echo $address;?>">
