...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$has_error)
    {
        ...
        $userType = (string) trim($_POST['userType']);

        // Create a new customer record
        $addUser = addUser($firstname, $lastname, $password, $userType);

        $status = '';
        if ($addUser === FALSE) {
            $status = 'error';
			
        } elseif ($addUser === 'existing'){
            $status = 'existing';
        }
        else{
            saveLog($_SESSION['user']['UserID'], 'Added ' . $firstname . ' ' . $lastname . ' as '. $userType);
            $status = 'success';     
        }
        header('Location: http://localhost/inventory_markscent/addUser.php?addUser_status='.$status);
        exit();
    }
   }
?>
...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-10">
            ...
            <br>
            <?php
		        if(isset($_GET['addUser_status']) && $_GET['addUser_status'] == 'success')
		    {
			    echo '<div class="alert-green" >The User has been successfully added.</div>';
		    }
		    elseif(isset($_GET['addUser_status']) && $_GET['addUser_status'] == 'error')
			{
			    echo '<div class="alert-red" >Error: Unable to add the User.</div>';
		    }
            elseif(isset($_GET['addUser_status']) && $_GET['addUser_status'] == 'existing')
			{
			    echo '<div class="alert-red" >Error: User already Exist.</div>';
		    }
	        ?> 
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="firstname" class="form-control <?php if(isset($firstname_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter First Name" value="<?php if(isset($firstname)) echo $firstname;?>">
            ...
            <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="lastname" class="form-control <?php if(isset($lastname_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Last Name" value="<?php if(isset($lastname)) echo $lastname;?>">
            ...
            <?php endif; ?>
                  ...
                  <div class="form-group">
                    ...
                    <input type="password" name="password" class="form-control <?php if(isset($password_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Password" value="<?php if(isset($password)) echo $password;?>">
