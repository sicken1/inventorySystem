...
if (isset($_GET['id'])) {
    $categoryID = $_GET['id'];
    // Retrieve the Category record by ID
    $category = getCategorybyCategoryID($categoryID);
} else {
    // Redirect to the categoryList.php page if none is provided
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
   ...
   // Check if the category name already exists
        ...
        if ($existingCategory) {
            ...
            $has_error = TRUE;
            $categoryname_error_msg = 'Category already exists.';
        } else {
        $categoryname = (string) trim($_POST['categoryname']);

        // Edit Category record
        $updateCategory = updateCategory($categoryID, $categoryname);

        if ($updateCategory === FALSE) {
          $notification_message = '<div class="alert-red">Error: Unable to update the Category.</div>';
          $_SESSION['notification_message'] = $notification_message;
        }
        else{
          $notification_message = '<div class="alert-green">The Category has been successfully updated.</div>';
          saveLog($_SESSION['user']['UserID'], 'Edited Information of Category ID: '. $categoryID);
          $_SESSION['notification_message'] = $notification_message;
        }
        header('Location: http://localhost/inventory_markscent/categoriesList.php');
        exit;
    }
   }
 }
...
<!-- /.navbar -->
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="admin_dashboard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="categoriesList.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-6 ml-1">
            <div>
              <a class="btn btn-primary btn-md" href="categoriesList.php">
              ...
              <form method="post">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" name="categoryname" class="form-control <?php if(isset($categoryname_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Category Name" value="<?php if(isset($category)) echo $category['CategoryName'];?>">
                    <?php if(isset($categoryname_error_msg)): ?>
                <div class="invalid-feedback"><?php echo $categoryname_error_msg; ?></div>
            <?php endif; ?>
                  </div>
                <!-- /.card-body -->
                <div>
