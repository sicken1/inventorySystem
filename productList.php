...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-11">
            <div>
              <a class="btn btn-primary btn-md" href="addProduct.php">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <?php foreach ($products as $product) : ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-info btn-xs" href="edit_product.php?id=<?php echo $product['ProductID']; ?>">
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (product) {
        var row = '<tr><td>' + product.ProductID + '</td>' +
          ...
          '<td>' +
            '<a class="btn btn-info btn-xs" href="edit_product.php?id=' + product.ProductID + '">' +
