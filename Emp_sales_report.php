    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="employee_dashboard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="Emp_sales_report.php" class="nav-link active">
...
$.ajax({
    url: 'functions/Emp_fetch_data.php', // Replace with your server-side endpoint
    type: 'POST',
    data: { start_date: startDate, end_date: endDate, user_id: <?php echo $user['UserID']; ?> },
    dataType: 'json',
