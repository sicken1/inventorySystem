   ...
   <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <strong><h1 class="m-0" style="font-weight: bold;">Employee Dashboard</h1></strong>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-3 col-4">
            ...
            <div class="small-box bg-info">
              <div class="inner">
              <?php
            $grandTotal = getGrandTotalUserSale($userID);
            ...
            ?>
              ...
              <a href="Emp_saleList.php" class="small-box-footer">View Sale <i class="fas fa-eye"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            ?>
              ...
              <a href="Emp_productList.php" class="small-box-footer">View Products<i class="fas fa-eye"></i></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
              <?php
            $cCount = count(getAllCategories());
            echo "<h3 style='color: #fff;'>{$cCount}</h3>";
            ?>
              ...
              <a href="Emp_categoriesList.php" class="small-box-footer">View Categories<i class="fas fa-eye"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            ?>
              ...
              <a href="Emp_customerList.php" class="small-box-footer">View Customers <i class="fas fa-eye"></i></a>
            </div>
          </div>
          <!-- ./col -->
        </div>
