...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (!$has_error)
  {
      ...
      header('Location: http://localhost/inventory_markscent/categoriesList.php?addCategory_status='.$status);
      exit();
  }
}
              ...
              <form method="post">
                <div class="card-body">
                  ...
                  <label for="category">Category Name</label>
                    <input type="text" name="categoryname" class="form-control <?php if(isset($categoryname_error_msg)) echo 'is-invalid'; ?>" placeholder="Enter Category Name" value="<?php if(isset($categoryname)) echo $categoryname;?>">
          ...
          <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="card-tools">
                <form method="GET" action="categoriesList.php">
                  ...
                  <?php else : ?>
                    <?php foreach ($categories as $category) : ?>
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-info btn-xs" href="edit_category.php?id=<?php echo $category['CategoryID']; ?>">
...
<script>
  ...
  }, 4000); // Adjust the time as needed (in milliseconds)
</script>
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (category) {
        var row = '<tr><td>' + category.CategoryID + '</td>' +
          ...
          '<td>' +
            '<a class="btn btn-info btn-xs" href="edit_category.php?id=' + category.CategoryID + '">' +
              '<i class="fas fa-pencil-alt"></i> Edit' +
            '</a>' +
