...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-11">
            <div>
              <a class="btn btn-primary btn-md" href="addCustomer.php">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <?php foreach ($customers as $customer) : ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-info btn-xs" href="edit_customer.php?id=<?php echo $customer['CustomerID']; ?>">
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (customer) {
        var row = '<tr><td>' + customer.CustomerID + '</td>' +
          ...
          '<td>' +
            '<a class="btn btn-info btn-xs" href="edit_customer.php?id=' + customer.CustomerID + '">' +
