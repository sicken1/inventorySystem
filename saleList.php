...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-11">
            <div>
              <a class="btn btn-primary btn-md" href="addSale.php">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form method="GET" action="saleList.php">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <?php foreach ($sales as $sale) : ?>
                    <tr>
                      ...
                      <td>
                        <a class="btn btn-info btn-xs" href="edit_sale.php?id=<?php echo $sale['SaleID']; ?>">
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (sale) {
        var row = '<tr><td>' + sale.SaleID + '</td>' +
          ...
          '<td>' +
            '<a class="btn btn-info btn-xs" href="edit_sale.php?id=' + sale.SaleID + '">' +
