...
if (isset($_GET['search'])) {
  $search = $_GET['search'];
  $sales = searchUserSale($search, $userID);
} else {
  $sales =getUserSale($userID);
}
...
<!-- /.navbar -->
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-11">
            <div>
              <a class="btn btn-primary btn-md" href="EmpaddSale.php">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form method="GET" action="Emp_saleList.php">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <?php foreach ($sales as $sale) : ?>
                    <tr>
                      ...
                      <td><?php echo $sale['QuantitySold']; ?></td>
                      <td><?php echo $sale['TotalAmount']; ?></td>
                      <td><?php echo $sale['DateCreated']; ?></td>
                      <td><?php echo $sale['DateUpdated']; ?></td>
                      <td>
                        <a class="btn btn-info btn-xs" href="Emp_edit_sale.php?id=<?php echo $sale['SaleID']; ?>">
                          <i class="fas fa-pencil-alt"></i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-xs" href="delete_sale.php?id=<?php echo $sale['SaleID']; ?>" 
                        class="delete-link" onclick="return confirm('Are you sure you want to delete this Sale?');">
...
$(document).ready(function () {
  ...
  function updateTable(page) {
    ...
    for (var i = startIndex; i <= endIndex && i < sales.length; i++) {
      currentEntries.push(sales[i]);
    }
    ...
    // Update pagination
    updatePagination(sales.length, page);

    // Update showing info
    updateShowingInfo(startIndex + 1, Math.min(endIndex + 1, sales.length), sales.length);
  }
  ...
  function updateTableBody(entries) {
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (sale) {
        var row = '<tr><td>' + sale.SaleID + '</td>' +
          ...
          '<td>' + sale.DateUpdated + '</td>' +
          '<td>' +
            '<a class="btn btn-info btn-xs" href="Emp_edit_sale.php?id=' + sale.SaleID + '">' +
              '<i class="fas fa-pencil-alt"></i> Edit' +
            '</a>' +
            '<a class="btn btn-danger btn-xs" href="delete_sale.php?id=' + sale.SaleID + '" class="delete-link" onclick="return confirm(\'Are you sure you want to delete this Sale and all of its Related Data?\');">' +
