...
<!-- /.navbar -->
    ...
    <div class="sidebar">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <a href="employee_dashboard.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="Emp_productList.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-11">
            <!-- <div>
              <a class="btn btn-primary btn-md" href="EmpaddProduct.php">
            ...
            <div class="card card-primary">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form method="GET" action="Emp_productList.php">
                ...
                <table class="table table-bordered table-striped">
                  ...
                  <?php foreach ($products as $product) : ?>
                    <tr>
                      ...
                      <td><?php echo $product['DateUpdated']; ?></td>
                      <!-- <td>
                        <a class="btn btn-info btn-xs" href="Emp_edit_product.php?id=<?php echo $product['ProductID']; ?>">
                          <i class="fas fa-pencil-alt"></i>
                          Edit
                        </a>
                        <a class="btn btn-danger btn-xs" href="delete_product.php?id=<?php echo $product['ProductID']; ?>" 
                        class="delete-link" onclick="return confirm('Are you sure you want to delete this Product?');">
...
$(document).ready(function () {
  ...
  function updateTable(page) {
    ...
    for (var i = startIndex; i <= endIndex && i < products.length; i++) {
      currentEntries.push(products[i]);
    }
    ...
    // Update showing info
    updateShowingInfo(startIndex + 1, Math.min(endIndex + 1, products.length), products.length);
  }
  ...
  function updateTableBody(entries) {
    ...
    if (entries.length === 0) {
      ...
      entries.forEach(function (product) {
        var row = '<tr><td>' + product.ProductID + '</td>' +
...
<!-- '<td>' +
            '<a class="btn btn-info btn-xs" href="Emp_edit_product.php?id=' + product.ProductID + '">' +
              '<i class="fas fa-pencil-alt"></i> Edit' +
            '</a>' +
            '<a class="btn btn-danger btn-xs" href="delete_product.php?id=' + product.ProductID + '" class="delete-link" onclick="return confirm(\'Are you sure you want to delete this Product and all of its Related Data?\');">' +
